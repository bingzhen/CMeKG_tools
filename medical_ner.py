...
class medical_ner(object):
    def __init__(self):
        self.NEWPATH = '/home/bingzhen/Desktop/model_warehouse/CMeKG_tools/weights/medical_ner/model.pkl'
        self.vocab = load_vocab('/home/bingzhen/Desktop/model_warehouse/CMeKG_tools/weights/medical_ner/vocab.txt')
        self.vocab_reverse = {v: k for k, v in self.vocab.items()}

        self.model = BERT_LSTM_CRF('/home/bingzhen/Desktop/model_warehouse/CMeKG_tools/weights/medical_ner', tagset_size, 768, 200, 2,
